...
FROM `gabinete-compartilhado.camara_v1_processed.proposicao_votacao_deputado_processed` AS v
-- Junta com as orientações de todos os partidos (e gov, etc.), para cada votação:
LEFT JOIN `gabinete-compartilhado.camara_v1_processed.proposicao_votacao_bancada_expandida` as o
