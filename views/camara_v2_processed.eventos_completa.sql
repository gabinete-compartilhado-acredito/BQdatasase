...
SELECT
  -- Info do órgão:
  x.id_orgao, x.sigla_orgao, o.nome, o.tipo_orgao,
  -- Info do evento:
  e.id_evento, e.data_hora_inicio, e.data_hora_fim, e.local_camara_nome, e.descricao_tipo, --e.url_documento_pauta,
  -- Info da pauta:
...
LEFT JOIN `gabinete-compartilhado.camara_v2_processed.eventos_orgaos_cleaned` AS x ON e.id_evento = x.id_evento
LEFT JOIN `gabinete-compartilhado.camara_v2_processed.orgaos_cleaned` AS o ON x.id_orgao = o.id_orgao
